...
<template>
  <div class="page-container"><div class="page-header"><h2><i class="fas fa-list" />题目列表</h2><span class="problem-count">共 {{ problems.length }} 题</span></div>
    <div class="table-wrapper"><table class="problem-table"><thead><tr><th class="col-id">#</th><th class="col-title">题目名称</th><th class="col-diff">难度</th><th class="col-rate">通过率</th><th class="col-status">我的状态</th></tr></thead><tbody>
