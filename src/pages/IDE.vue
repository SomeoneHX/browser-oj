...
const language = ref<LanguageId>(draft.language)
...
const onLanguageChange = (event: Event) => {
  language.value = (event.target as HTMLSelectElement).value as LanguageId
}
