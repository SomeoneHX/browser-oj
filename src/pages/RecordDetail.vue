...
const statusConfig = (status) => ({ compiling: ['fa-cog fa-spin', '编译中', '#1677ff'], running: ['fa-spinner fa-spin', '评测中', '#1677ff'], tle: ['fa-clock', '运行超时', '#f5222d'], error: ['fa-exclamation-circle', '运行错误', '#f5222d'], ac: ['fa-check-circle', '通过', '#52c41a'] }[status] || ['fa-times-circle', '未通过', '#faad14'])
